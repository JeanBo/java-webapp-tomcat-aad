...
public class AppBean {
	...
	public void init(){
		...
		String rCounter = jedis.get("redisCounter");
		if(rCounter == null){
			jedis.set("redisCounter","1");	
			redisCounter = 1;
		}else{
			logger.info("rCounter from REDIS = "+rCounter);
			redisCounter = new Integer(rCounter).intValue();
			redisCounter++;
			jedis.set("redisCounter",new Integer(redisCounter).toString());
		}
	...
	public void setRedisCounter(int redisCounter) {
