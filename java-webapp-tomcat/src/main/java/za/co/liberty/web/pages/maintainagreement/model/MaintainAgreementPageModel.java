 ...
 */
public class MaintainAgreementPageModel implements
		ITabbedPageModel<MaintainAgreementDTO>,
		IModalMaintenancePageModel<MaintainAgreementDTO>,
		Serializable {
	...
	private MaintainAgreementDTO selectedItem;
	...
	private List<TypeVO> businessStakeHolderTypes = new ArrayList<TypeVO>();
	...
	// Used for linking home to other roles
	private RoleKindType removeHomeRoleKindType;
	
	private Boolean isOrganisation;
	
	private String modalWizardMessage;
	...
	public MaintainAgreementPageModel() {
		super();
	}
	 ...
	 */
	public MaintainAgreementPageModel(AgreementDTO agreementDTO,
	...
	public MaintainAgreementDTO getSelectedItem() {
		return selectedItem;
	}

	public List<MaintainAgreementDTO> getSelectionList() {
		return null;
	}
	...
	public void setSelectionList(List<MaintainAgreementDTO> selectionList) {
	}
	...
	public List<TypeVO> getBusinessStakeHolderTypes() {
		return businessStakeHolderTypes;
	}


	public void setBusinessStakeHolderTypes(List<TypeVO> businessStakeHolderTypes) {
		this.businessStakeHolderTypes = businessStakeHolderTypes;
	}
	...
	public TypeVO getBusinessType(long typeID){
		for(TypeVO type : this.getBusinessStakeHolderTypes()){
			if(type.getOid() == typeID){
				return type;
			}
		}
	...
	public RoleKindType getRemoveHomeRoleKindType() {
		return removeHomeRoleKindType;
	}


	public void setRemoveHomeRoleKindType(RoleKindType removeHomeRoleKindType) {
		this.removeHomeRoleKindType = removeHomeRoleKindType;
	}
	...
	public String getModalWizardMessage() {
		return modalWizardMessage;
	}

	public void setModalWizardMessage(String s) {
		modalWizardMessage = s;
	}
}
