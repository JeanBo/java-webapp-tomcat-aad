 ...
 *
 */
public class COREDataGrid extends COREDefaultDataGrid implements IStatefullComponent {
...
//		calculateTableHeight();		
	...
	public COREDataGrid(String id, IDataSource dataSource, List<IGridColumn> columns , EditStateType state) {
		super(id, dataSource, columns);	
		this.currentState = state;
		init();
	}	

	public COREDataGrid(String id, IModel model, List<IGridColumn> columns, EditStateType state) {
	...
	public COREDataGrid(String id, IModel model, List<IGridColumn> columns, EditStateType state, List nonSelectableRowObjects) {
		super(id, model, columns);
		this.currentState = state;
	...
	@SuppressWarnings("unchecked")
	public COREDataGrid(String id, IDataSource dataSource, List<IGridColumn> columns , EditStateType state, List nonSelectableRowObjects) {
		super(id, dataSource, columns);	
		this.currentState = state;
		this.nonSelectableRowObjects = new HashMap();
		if(nonSelectableRowObjects != null){
