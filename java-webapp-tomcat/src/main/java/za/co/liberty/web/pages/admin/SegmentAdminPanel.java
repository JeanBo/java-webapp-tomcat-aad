...
public class SegmentAdminPanel extends BasePanel {

	private static final long serialVersionUID = 1L;
	
	private static final Logger logger = Logger.getLogger(SegmentAdminPanel.class);
	private SegmentModel pageModel = null;
	...
	public SegmentAdminPanel(String id, EditStateType editState){
		super (id, editState);
	}
	...
	public SegmentAdminPanel(String id, EditStateType editState, SegmentModel pageModel, MaintenanceBasePage parentPage) {
