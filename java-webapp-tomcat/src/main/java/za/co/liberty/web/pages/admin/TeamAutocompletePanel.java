...
public abstract class TeamAutocompletePanel<DTO extends Object> extends 
	 ...
	 * @param dtoType
	 */
	public TeamAutocompletePanel(String id, String listLabel,
	...
	private ModalWindow createSearchWindow(String id) {
		...
		ContextSearchPopUp popUp = new ContextSearchPopUp() {
			...
			public void doProcessSelectedItems(AjaxRequestTarget target,
				...
				TeamAutocompletePanel.this.doProcessSearchResult(target, selectedItemList);
			}
