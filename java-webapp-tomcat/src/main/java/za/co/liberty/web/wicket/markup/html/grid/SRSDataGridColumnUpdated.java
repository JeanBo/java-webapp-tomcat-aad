 ...
 * <p>The newCellPanel is called for each cell, A new panel should be produced as a result </p>
 * 
 * <p>Override {@link #getPropertyValue(Object, String)} method if you need to get the property data
 * without using bean property conversion.   This means objectProperty will then be ignored.</p>
 * 
 * @author DZS2610
 * @author jzb0608 2023 Updated to support object data retrieval via additional methods
 *
 */
public class SRSDataGridColumnUpdated<DATAObject extends Object> extends AbstractColumn {
	...
	public SRSDataGridColumnUpdated(String columnId, IModel headerModel,String objectProperty, EditStateType state) {
		super(columnId, headerModel);		
		this.objectProperty = objectProperty;
		this.state = state;
	}	

	public SRSDataGridColumnUpdated(String columnId, IModel headerModel, String sortProperty,String objectProperty, EditStateType state) {
