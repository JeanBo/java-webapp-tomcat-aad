 ...
 * 
 */
public class MaintainAgreementPanel extends MaintenanceTabbedPanel {
	 ...
	 */
	public MaintainAgreementPanel(String id, ITabbedPageModel<MaintainAgreementDTO> pageModel,
			...
			public Panel createPanel(String id) {
				if (agreementPanel == null) {
					agreementPanel = new AgreementDetailsPanel(
							...
							MaintainAgreementPanel.this.getEditState(),
