 ...
 * @author Sven Meier
 */
public class BeginnersTreePage extends WebPage
{
    ...
    {
        NestedTree tree = new DefaultNestedTree<Foo>("tree", new FooProvider())
        {
        ...
        NestedTree tree2 = new DefaultNestedTree<Foo>("tree2", new FooProvider())
        {
